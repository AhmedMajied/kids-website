var tones = [new Audio('audios\\1.mp3'), new Audio('audios\\2.mp3') , new Audio('audios\\3.mp3') , new Audio('audios\\4.mp3') , new Audio('audios\\5.mp3') , new Audio('audios\\6.mp3') , new Audio('audios\\7.mp3') , new Audio('audios\\8.mp3') , new Audio('audios\\9.mp3') , new Audio('audios\\10.mp3') ];

var buttons = ["but1","but2","but3","but4","but5","but6","but7","but8","but9","but10"];

var wrongAnswer = new Audio('audios\\wrong_sound.mp3');
var rightAnswer = new Audio('audios\\right_sound.mp3');
var level=1;
